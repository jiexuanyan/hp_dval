...
def analyze_clip_vit_model(args):
    """Analyze CLIPVIT model from clip_vit.py"""
    print("=" * 60)
    print("CLIPVIT MODEL ANALYSIS (First Stage)")
    print("=" * 60)
...
def analyze_prompt_learner_model(args):
    """Analyze PromptLearner model"""
    print("=" * 60)
    print("PROMPT LEARNER MODEL ANALYSIS (Second Stage)")
    print("=" * 60)
...
def main(args):
    ...
    try:
        # First stage model (CLIPVIT)
        results['clip_vit'] = analyze_clip_vit_model(args)
        
        # Second stage model (PromptLearner)
        results['prompt_learner'] = analyze_prompt_learner_model(args)
