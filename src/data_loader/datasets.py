    ...
    def __init__(self, dataset, split, clip_model):
        ...
        if dataset == 'coco-lt':
            self.data_source = ImageListCaption(root='/data2/yanjiexuan/coco/data/',
                                        list_file='/home/yanjiexuan/multi-label-fsl/MKT-LT/data/coco/coco_lt_%s.txt' % split,
                                        caption_file='/home/yanjiexuan/multi-label-fsl/MKT-LT/data/coco/coco_lt_captions.txt',
                                        label_file='/home/yanjiexuan/multi-label-fsl/MKT-LT/data/coco/coco_labels.txt',
                                        nb_classes=80,
                                        split=split,
                                        clip_model=clip_model)
        elif dataset == 'voc-lt':
            self.data_source = ImageListCaption(root='/data2/yanjiexuan/voc',
                                        list_file='/home/yanjiexuan/multi-label-fsl/MKT-LT/data/voc/voc_lt_%s.txt' % split,
                                        caption_file='/home/yanjiexuan/multi-label-fsl/MKT-LT/data/voc/voc_lt_captions.txt',
                                        label_file='/home/yanjiexuan/multi-label-fsl/MKT-LT/data/voc/voc_labels.txt',
                                        nb_classes=20,
                                        split=split,
                                        clip_model=clip_model)
