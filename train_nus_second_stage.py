...
def main(args):
    ...
    if not args.eval:
        ...
        args.record_path = os.path.join("logger", "second_stage", record_name)
        ...
        #train_dataloader = DataLoader(train_dataset,  args.batch_size,pin_memory=True, sampler=train_sampler, num_workers=args.workers,  drop_last=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt-path",              type=str,   default='/home/liubeiyan/first_stage_best_model_nus.pth'    )
